...
--==================================================================================================================================================
-- FROM FUNCTION: compare_load_md5_metadata_tbl
--==================================================================================================================================================
WITH
...
--==================================================================================================================================================
   ...
   schema_name    | object_type | object_type_name | object_subtype | object_subtype_name |            object_md5            | change_type
------------------+-------------+------------------+----------------+---------------------+----------------------------------+-------------
 analytics_schema | Table       | departments      | Column         | location            |                                  | DELETED
 analytics_schema | Table       | departments      | Column         | location_new        | 194c7795dfa2987255dfc248e379b863 | ADDED
 analytics_schema | Table       | departments      | Column         | location_old        | d6e08099dee6077445cfbdf123772ea9 | ADDED
 analytics_schema | Table       | departments      | Column         | location_old        | d6e08099dee6077445cfbdf123772ea9 | RENAMED
 analytics_schema | Table       | departments      | Column         | ternary_location    |                                  | DELETED

    schema_name    | object_type | object_type_name | object_subtype | object_subtype_name |            object_md5            |          processed_time          | change_type
------------------+-------------+------------------+----------------+---------------------+----------------------------------+----------------------------------+-------------
 analytics_schema | Table       | departments      | Column         | location_new        | 194c7795dfa2987255dfc248e379b863 | 2025-11-07 11:04:28.086646+05:30 | ADDED
 analytics_schema | Table       | departments      | Column         | location_old        | d6e08099dee6077445cfbdf123772ea9 | 2025-11-07 11:04:28.086565+05:30 | RENAMED
 analytics_schema | Table       | departments      | Column         | ternary_location    |                                  | 2025-11-07 11:04:28.08671+05:30  | DELETED